...
def fix_my_data(file_path):
    sys_prompt = r"""
You're an intellegent ai expert in maths, and you're going to solve a math problem presented by the user.
Please follow the requirements below:
1. Answer this problem step by step.
2. Think before you answer, write your thoughts like this <think>YOUR THOUGHTS</think>
3. Demonstrate your answer in this form: \boxed{YOUR ANSWER}.
"""
    ...
    df['prompt'] = df[problem_col].apply(lambda x: [
...
# 执行修复
fix_my_data("/data/home/huangqiyuan/data/math_train_fixed.parquet")
fix_my_data("/data/home/huangqiyuan/data/math_test_fixed.parquet")